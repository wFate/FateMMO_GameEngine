...
> **75,200 lines** across **425 files** — engine (23.2K), game (27.8K), server (11.8K), tests (12.4K)
...
| **Database** | PostgreSQL (libpqxx), connection pool + circuit breaker, write-ahead log |
...
41 gameplay systems ported from a Unity/C# prototype and expanded with new content — all server-authoritative.
...
- **Skill Manager** — 60 skills with learning, cooldowns, 4×5 skill bar, passive bonuses
...
- **Guild** — ranks, 16×16 pixel symbols, XP contribution, member management
...
- **Mob AI** — TWOM-style cardinal movement, L-shaped chase, threat-based aggro (top damager holds)
...
- **Pet System** — leveling, rarity-tiered stats, XP sharing (50%), equip/unequip with stat bonuses
...
│                circuit breaker, write-ahead log, staggered auto-save
...
```
 75,200 lines of C++     ·     425 files     ·     708 tests     ·     1 developer
```
