...
struct CachedSkillDef {
    ...
    std::string vfxId;  // VFX definition key (empty = no visual effect)
};
...
public:
    ...
    [[nodiscard]] const auto& allMobs() const { return mobs_; }
...
public:
    ...
    [[nodiscard]] const auto& allSkills() const { return skills_; }
    [[nodiscard]] const auto& allRanks() const { return ranks_; }
