...
TEST_CASE("Expanded SvEntityUpdateMsg round-trips all fields") {
    ...
    msg.persistentId = 42;
    msg.fieldMask = 0x1FFFF; // all 17 bits (0-16)
    ...
    msg.level = 25;
    msg.faction = 2;
    msg.armorStyle = "plate_1";
    msg.hatStyle = "helm_1";
    msg.weaponStyle = "sword_1";
    msg.pkStatus = 1;
    msg.honorRank = 3;
    msg.costumeVisuals = 0x12345678;
    msg.updateSeq = 7;
    ...
    CHECK(decoded.armorStyle == "plate_1");
    CHECK(decoded.hatStyle == "helm_1");
    CHECK(decoded.weaponStyle == "sword_1");
    CHECK(decoded.pkStatus == 1);
    CHECK(decoded.honorRank == 3);
    CHECK(decoded.costumeVisuals == 0x12345678);
